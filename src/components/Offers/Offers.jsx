    ...
    return (
      <div className='mt-[24px] flex justify-between gap-[24px] mb-[40px] px-[100px]'>
        {offer.map((items, index) => (
          <div key={index} className='w-[295px] h-[120px] bg-slate-50 flex justify-evenly gap-[24px] pl-[24px] pr-[19px] rounded-md'>
            <div className='w-[48px] h-[48px]'>
              <img src={items.img} alt="" className='pt-[37px] pb-[35px]'/>
            </div>
            <div className='pt-[27px] pb-[37px] w-[180px] h-[56px]'>
              <h3 className='text-[16px] text-[#676767] font-semibold'>{items.title}</h3>
