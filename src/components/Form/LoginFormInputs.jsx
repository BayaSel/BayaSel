...
export default function LoginFormInputs() {
  return (
    <>
      ...
      <input
        className="w-[80%] my-3 py-3 pl-3 border rounded-[0.5rem] inline-block cursor-pointer outline-none focus:outline-[#4baf47] hover:outline-[#4baf47]"
        type="text"
      ...
      <button
        className="w-[80%] bg-[#4BAF47] py-2 rounded-[0.5rem] text-[#fff]"
        type="submit"
      >
        Sign In
      </button>
